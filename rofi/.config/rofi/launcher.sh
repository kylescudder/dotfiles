...
case "$show_mode" in
    drun|window|run|media|sound|session) ;;
    *) show_mode="drun" ;;
esac
...
mode_list="drun,window,run,media:$config_dir/scripts/media,sound:$config_dir/scripts/sound,session:$config_dir/scripts/session"
